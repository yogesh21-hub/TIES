...
class SubjectWiseStatsDiallog extends StatefulWidget {
  @override
  _SubjectWiseStatsDiallogState createState() =>
      _SubjectWiseStatsDiallogState();
}

class _SubjectWiseStatsDiallogState extends State<SubjectWiseStatsDiallog> {
