...
class TeacherSubjectDialog extends StatefulWidget {
  @override
  _TeacherSubjectDialogState createState() => _TeacherSubjectDialogState();
}

class _TeacherSubjectDialogState extends State<TeacherSubjectDialog> {
  @override
...
class _subjectquizzes extends StatelessWidget {
  const _subjectquizzes({
    Key key,
  }) : super(key: key);
