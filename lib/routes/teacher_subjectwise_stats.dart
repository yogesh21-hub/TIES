import 'package:TIES/dialogs/teacher_subjectwise_stats_dialog.dart';
import 'package:flutter/material.dart';

class TeacherSubjectWiseStats extends StatefulWidget {
  @override
  _TeacherSubjectWiseStatsState createState() => _TeacherSubjectWiseStatsState();
}

class _TeacherSubjectWiseStatsState extends State<TeacherSubjectWiseStats> {
  @override
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          onTap: () {
            ...
            builder:(context){
              return TeacherSubjectWiseStatsDiallog();
            }
            );
          },
        ),
